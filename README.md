...
Query:
SELECT COUNT(*) FROM dsai-468212.olist_staging.public_olist_orders_dataset WHERE order_approved_at = '';
SELECT COUNT(*) FROM dsai-468212.olist_staging.public_olist_orders_dataset WHERE order_delivered_carrier_date = '';
